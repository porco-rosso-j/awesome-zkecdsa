...
zkECDSA is the ECDSA signature verification carried out through zero-knowledge circuits, which opens up a path to explore various privacy-preserving use cases. 
